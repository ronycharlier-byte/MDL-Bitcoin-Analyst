...
| G-003 | Fundamental coverage is partial: live API runs may include real point-in-time values for ETF flows, funding rate, open interest, hash rate, stablecoin supply, DXY, US rates and Nasdaq when sources respond; missing fields remain absent. | data_quality | high | partial_real_absent |
